...
- **Contribution/ContributionRecur metadata updates for EntityForm
  ...
  that they can be used to autogenerate forms.
...
- **Standardize format for entityRef create links
  ...
  the clientside so that they work equally well with all entities.
...
- **Improves styling on Joomla! upgrade screen
  ...
  This change improves the styling on the Joomla upgrade screen.
...
- **[dev/core#642](https://lab.civicrm.org/dev/core/issues/642) New Contact
  ...
  This change ensures that one selects the action "Create Report" on the
