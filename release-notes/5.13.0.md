...
- **[dev/core#824](https://lab.civicrm.org/dev/core/issues/824) What to do with
  the merge screen
  ([13898](https://github.com/civicrm/civicrm-core/pull/13898)) Continued Work**

  This change continues work to clean up the Merge screen by moving toward using
  contact type icons in a standard way instead of the contact type names.
