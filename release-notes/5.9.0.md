...
- **Make world_region translate on advanced search field
  ...
  This field ensures that on the Advanced Search Form the world region field
  gets translated.

- **Fix Job Log entries containing links so they will display properly
  ([12659](https://github.com/civicrm/civicrm-core/pull/12659))**

  This change improves the links/general html formating when viewing the log for
...
### CiviEvent- **Update npm dependencies to fix audit issues
  ([13195](https://github.com/civicrm/civicrm-core/pull/13195))**
...
- **Display message template title on deletion form
  ...
  displaying the Message Template name in the Are you sure you want to delete
  this Mesage Template Confirmation popup.
...
- **[dev/core#563](https://lab.civicrm.org/dev/core/issues/563) Duplicate Case
  ...
  This fixes a bug where editing a civi case manager resulted in a duplicate
...
- **[dev/core#467](https://lab.civicrm.org/dev/core/issues/467) Case Start Date
  ...
  This change fixes a bug where attempting to update a case start date or
...
- **[dev/core#557](https://lab.civicrm.org/dev/core/issues/557) Prevent jump
  ...
  This change upgrades from Quickform 3.2.11 to 3.2.16.
...
- **[dev/core#526](https://lab.civicrm.org/dev/core/issues/526) Feedback cannot
  ...
  This change fixes a bug where, when saving a Contribution settings form in
  languages other than English, the feedback given is not translated or
  translatable.
...
- **Fix continue / break warning under PHP 7.3 ([228](https://github.com/civicrm/civicrm-packages/pull/228))**
  ...
  This change fixes a bug for users under PHP 7.3 where a warning would
