...
- **Move permission access handling for civicrm/admin/financial/financialType?reset=1 to extension ([22685](https://github.com/civicrm/civicrm-core/pull/22685) and [22499](https://github.com/civicrm/civicrm-core/pull/22499))**

- **Expose a REST end-point through standard routing (Work Towards
  [dev/core#2077](https://lab.civicrm.org/dev/core/-/issues/2077):
  [19727](https://github.com/civicrm/civicrm-core/pull/19727))**

  Makes 'civicrm/ajax/rest' interoperable with 'extern/rest.php' parameters.
...
- **updating misleading labels on buttons to confirmation pages
  ...
  Changes event registration button text based on if there are additional
  participants.
...
- **dev/core#2866 Generate text version of message at send time if not present ([22634](https://github.com/civicrm/civicrm-core/pull/22634) and [22632](https://github.com/civicrm/civicrm-core/pull/22632))**

- **dev/core#2989 - validate campaign id for contribution import ([22235](https://github.com/civicrm/civicrm-core/pull/22235))**

- **(dev/core#3012) Expose email on hold as filter for contribution report ([22368](https://github.com/civicrm/civicrm-core/pull/22368) and [22572](https://github.com/civicrm/civicrm-core/pull/22572))**
