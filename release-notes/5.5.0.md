...
- **[dev/core#217](https://lab.civicrm.org/dev/core/issues/217) Allow
  ...
  [12438](https://github.com/civicrm/civicrm-core/pull/12438))**

  Preliminary work to allow contact searches to retain their results via Redis/Memcache
  (instead of MySQL).
...
- **Fix quirks in upgrader UI ([12675](https://github.com/civicrm/civicrm-core/pull/12675))** BACKPORT ANDREW I THINK THIS BELONGS IN 5.4.1
