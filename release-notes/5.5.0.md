...
- **[dev/core/#273](https://lab.civicrm.org/dev/core/issues/273) Fix issue where sending an SMS with the To Field in the… ([12654](https://github.com/civicrm/civicrm-core/pull/12654))**

- **[dev/core/#273](https://lab.civicrm.org/dev/core/issues/273) Fix issue where sending an SMS with the To Field in the… ([12634](https://github.com/civicrm/civicrm-core/pull/12634))**

- **[dev/core#316](https://lab.civicrm.org/dev/core/issues/316) Fix crash on Memcache systems when session key involves whitespace ([12653](https://github.com/civicrm/civicrm-core/pull/12653))**

- **[dev/core#316](https://lab.civicrm.org/dev/core/issues/316) Fix crash on Memcache systems when session key involves whitespace ([12640](https://github.com/civicrm/civicrm-core/pull/12640))**
...
- **[dev/core#289](https://lab.civicrm.org/dev/core/issues/289) - Fix links on case dashboard ([12607](https://github.com/civicrm/civicrm-core/pull/12607))**

- **[dev/core#277](https://lab.civicrm.org/dev/core/issues/277) Sort recurring contributions by newest first ([12610](https://github.com/civicrm/civicrm-core/pull/12610))**

- **[dev/core#277](https://lab.civicrm.org/dev/core/issues/277) Fixed count to include only live recurring contr… ([12553](https://github.com/civicrm/civicrm-core/pull/12553))**

- **Customvalue ID is ignored ([12606](https://github.com/civicrm/civicrm-core/pull/12606))**

- **[dev/core#217](https://lab.civicrm.org/dev/core/issues/217) PrevNext - Allow swapping getPositions (etal) for contact-search ([12558](https://github.com/civicrm/civicrm-core/pull/12558))**

- **[dev/core#217](https://lab.civicrm.org/dev/core/issues/217) PrevNext - Migrate selection methods ([12556](https://github.com/civicrm/civicrm-core/pull/12556))**

- **[dev/core#217](https://lab.civicrm.org/dev/core/issues/217) PrevNext - Probe for best available implementation (memory-backed or SQL-backed) ([12543](https://github.com/civicrm/civicrm-core/pull/12543))**

- **[dev/core#217](https://lab.civicrm.org/dev/core/issues/217) CRM_Utils_Cache_Redis::connect() - Allow pooling connections ([12544](https://github.com/civicrm/civicrm-core/pull/12544))**

- **[dev/core#217](https://lab.civicrm.org/dev/core/issues/217) PrevNext - Define and use fillWithSql()/fillWithArray() ([12545](https://github.com/civicrm/civicrm-core/pull/12545))**

- **[dev/core#217](https://lab.civicrm.org/dev/core/issues/217) Add skeletal PrevNextCache service ([12528](https://github.com/civicrm/civicrm-core/pull/12528))**

- **[dev/core#217](https://lab.civicrm.org/dev/core/issues/217) CRM_Contact_Selector::getRows() - Use generator instead of DAO loop ([12438](https://github.com/civicrm/civicrm-core/pull/12438))**
...
- **[dev/core#291](https://lab.civicrm.org/dev/core/issues/291) Allow for field size to be set for password fields ([12589](https://github.com/civicrm/civicrm-core/pull/12589))**
...
- **[dev/financial#24](https://lab.civicrm.org/dev/financial/issues/24) Moved code from form layer to BAO and used api instead of BAO function ([12388](https://github.com/civicrm/civicrm-core/pull/12388))**

- **[dev/core#232](https://lab.civicrm.org/dev/core/issues/232) Some smart groups and some searches not returning any contacts ([12416](https://github.com/civicrm/civicrm-core/pull/12416))**
...
- **[dev/core#278](https://lab.civicrm.org/dev/core/issues/278) Fix DB syntax error when try to search deleted cases ([12560](https://github.com/civicrm/civicrm-core/pull/12560))**

- **[dev/core#210](https://lab.civicrm.org/dev/core/issues/210) Regex filter broken in Search Builder ([12364](https://github.com/civicrm/civicrm-core/pull/12364))**
...
- **[dev/core#244](https://lab.civicrm.org/dev/core/issues/244) Allow use of custom fields of type select without specifying an optiongroup ([12440](https://github.com/civicrm/civicrm-core/pull/12440))**

- **[dev/core#111](https://lab.civicrm.org/dev/core/issues/111) Support Custom Data for MembershipType entity ([12439](https://github.com/civicrm/civicrm-core/pull/12439))**
...
- **[dev/core#219][dev/core#217](https://lab.civicrm.org/dev/core/issues/219) Improve consistency displaying "Test Transactions" ([12385](https://github.com/civicrm/civicrm-core/pull/12385))**
...
- **[dev/core#242](https://lab.civicrm.org/dev/core/issues/242) Fix display of premiums on contribution page ([12437](https://github.com/civicrm/civicrm-core/pull/12437))**

- **[dev/financial#27](https://lab.civicrm.org/dev/financial/issues/27) Paypal_Standard recurring IPNs don't work ([12387](https://github.com/civicrm/civicrm-core/pull/12387))**

- **Link to option group page from option group menu item ([12540](https://github.com/civicrm/civicrm-core/pull/12540))**

- **[dev/core#259](https://lab.civicrm.org/dev/core/issues/259) OptionGroup Admin UI workflow improvements ([12473](https://github.com/civicrm/civicrm-core/pull/12473))**
...
- **[dev/accessibility#3](https://lab.civicrm.org/dev/accessibility/issues/3) Add aria-label to form elements of contribution page which don't have accessible labels ([12207](https://github.com/civicrm/civicrm-core/pull/12207))**

- **[dev/accessibility#3](https://lab.civicrm.org/dev/accessibility/issues/3) Add accessible label on Contact Edit form elements and helpicon ([12373](https://github.com/civicrm/civicrm-core/pull/12373))**
...
- **[dev/core#233](https://lab.civicrm.org/dev/core/issues/233) Expose information about where a contact has been merged to ([12489](https://github.com/civicrm/civicrm-core/pull/12489))**

- **Fix enotice in test ([12507](https://github.com/civicrm/civicrm-core/pull/12507))**

- **[dev/financial#28](https://lab.civicrm.org/dev/financial/issues/28) Financial Account cannot be change to non de… ([12500](https://github.com/civicrm/civicrm-core/pull/12500))**

- **[dev/core#34](https://lab.civicrm.org/dev/core/issues/34) Add permission details in `title` attribute of icons ([12487](https://github.com/civicrm/civicrm-core/pull/12487))**

- **[dev/core#34](https://lab.civicrm.org/dev/core/issues/34) Add view-only option on permissioned relationships ([12415](https://github.com/civicrm/civicrm-core/pull/12415))**
...
- **[dev/core#150](https://lab.civicrm.org/dev/core/issues/150) Chain select for country/state in Search Builder does not stay within OR groupings ([12230](https://github.com/civicrm/civicrm-core/pull/12230))**

- **[dev/core#230](https://lab.civicrm.org/dev/core/issues/230) set mapping id null on delete action ([12486](https://github.com/civicrm/civicrm-core/pull/12486))**
...
- **[dev/core#155](https://lab.civicrm.org/dev/core/issues/155) Fix optiongroup is_reserved data and use when selecting option group for custom fields ([12423](https://github.com/civicrm/civicrm-core/pull/12423))**
...
- **[dev/core#188](https://lab.civicrm.org/dev/core/issues/188) Fix Floating Point Precision Comparison Exception ([12352](https://github.com/civicrm/civicrm-core/pull/12352))**
...
- **[dev/core#141](https://lab.civicrm.org/dev/core/issues/141) only check if name exists. ([12464](https://github.com/civicrm/civicrm-core/pull/12464))**

- **[dev/core#256](https://lab.civicrm.org/dev/core/issues/256) - use unsigned int for temporary recipient ids ([12465](https://github.com/civicrm/civicrm-core/pull/12465))**
...
- **[dev/core#93](https://lab.civicrm.org/dev/core/issues/93) Update CRM_Utils_Rule::mysqlOrderBy() to accommodate more than 2 joins ([12456](https://github.com/civicrm/civicrm-core/pull/12456))**
...
- **[dev/mail#15](https://lab.civicrm.org/dev/mail/issues/15) deal better with spaces in from email address ([12346](https://github.com/civicrm/civicrm-core/pull/12346))**

- **CustomValue gettree api - More accurate permission check ([12449](https://github.com/civicrm/civicrm-core/pull/12449))**

- **[dev/core#241](https://lab.civicrm.org/dev/core/issues/241) Fix Manage Premiums UI ([12436](https://github.com/civicrm/civicrm-core/pull/12436))**

- **[dev/core#255](https://lab.civicrm.org/dev/core/issues/255) Changes to copied event location reflects in original … ([12459](https://github.com/civicrm/civicrm-core/pull/12459))**
...
- **[dev/core#221](https://lab.civicrm.org/dev/core/issues/221), check if the grouptree is not empty ([12392](https://github.com/civicrm/civicrm-core/pull/12392))**

- **5.4 ([12448](https://github.com/civicrm/civicrm-core/pull/12448))**

- **[dev/core#228](https://lab.civicrm.org/dev/core/issues/228) fix OptionGroup create action to not disable on update ([12410](https://github.com/civicrm/civicrm-core/pull/12410))**

- **[dev/core#218](https://lab.civicrm.org/dev/core/issues/218) On Case Type listing page, for reserved ones the, 'More' link don't show any options ([12384](https://github.com/civicrm/civicrm-core/pull/12384))**
...
- **[dev/core#239](https://lab.civicrm.org/dev/core/issues/239) Fix title dialog box on hovering form element on Event's configuration backend form ([12430](https://github.com/civicrm/civicrm-core/pull/12430))**

- **[dev/core#176](https://lab.civicrm.org/dev/core/issues/176) Odd / Even street number sort column missing from Reports ([12422](https://github.com/civicrm/civicrm-core/pull/12422))**

- **[dev/core#174](https://lab.civicrm.org/dev/core/issues/174) CRM_Utils_Cache_SqlGroup - Refine trivial TTL handling to stabilize tests ([12427](https://github.com/civicrm/civicrm-core/pull/12427))**
...
- **[dev/core#212](https://lab.civicrm.org/dev/core/issues/212) - Contribution Details report fails when 'Is not one of'… ([12406](https://github.com/civicrm/civicrm-core/pull/12406))**
...
- **[dev/core#292](https://lab.civicrm.org/dev/core/issues/292) Fix issue where accented characters were not properly ut… ([225](https://github.com/civicrm/civicrm-packages/pull/225))**

- **Menubar - use icon font instead of image ([223](https://github.com/civicrm/civicrm-packages/pull/223))**

- **[dev/core#243](https://lab.civicrm.org/dev/core/issues/243) Authenticate with Backdrop in kcfinder ([216](https://github.com/civicrm/civicrm-packages/pull/216))**
